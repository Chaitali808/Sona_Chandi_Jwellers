...
<body>
              ...
              <?php if (!empty($customers)) {
                ...
                foreach ($customers as $customer) { ?>
                  <tr>
                    ...
                    <td>
                      <i class="fa-solid fa-trash del-btn" data-id="<?= $customer->id ?>" style="cursor:pointer;"></i>
                    </td>
                  </tr>
                <?php }
              } ?>
  ...
  <script>
    ...
    document.querySelector(".btn-cancel-del").addEventListener("click", () => {
      ...
      selectedCustomerId = null; // clear selection
    });

    // Confirm deletion
    document.querySelector(".btn-yes").addEventListener("click", () => {
      if (selectedCustomerId) {
        fetch("<?= base_url('AdminController/deleteCustomerById') ?>", {
          method: "POST",
          headers: {
